      ...
      <script type="text/javascript">
         ...
         function userList() {
            ...
            $.ajax({
               ...
               success: function(data) {
                  var aList = "<table class='table table-hover' id='userview' style='border: 1px solid black; position: relative; top: 125px;'>";
         ...
         function cameraList(user_id) {
            ...
            $.ajax({
               ...
               dataType : "json",
               success : function(data){
                  var aList = "<table class='table table-hover' id='cameraview' style='position: relative;  top: 50px; right: 55px;''>";
                  aList += "<tr>";
                  aList += "<td>카메라 순번</td>";
                  aList += "<td>유저 아이디</td>";
                  aList += "<td>카메라 상태</td>";
