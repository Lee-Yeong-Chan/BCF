...
<html>
   ...
   <body>
      <a href="${cPath}/management.do">
           <img src="${cPath}/resources/logo3.png" alt="로고 설명" style="width: 217px;position: relative;top: -71px;left: -46px;">
       </a>
      ...
      <div style="position: relative;bottom: 64px;right: 57px;width: 32%;font-size: large;text-align: center;">
         <h1 style="text-align: center;">카메라 관리</h1>
            <div id="search">
            <span style="position: relative; right: 242px; top: 31px; font-size: 22px;">아이디 검색:</span><input type='text' id='cctvsearch' onkeyup='cameraList()' placeholder='아이디를 입력하면 검색' style="display: block;position: relative;left: 153px;">
            </div>
         <div id="cctv"></div>
      </div>
   </body>
