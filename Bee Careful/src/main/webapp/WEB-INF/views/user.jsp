   ...
   <body>
      <div class="top-navbar">
        ...
        <div style=" position: relative; bottom: 70px; width: 663px; font-size: x-large;">
         ...
         <span style=" position: relative; right: 138px; font-size: large; top:94px;">아이디 검색:</span><input type="text" id="usersearch" onkeyup="userList(1)" placeholder="아이디를 입력하면 검색" style=" position: relative; right: 130px; font-size: large; top:94px;">
         <button type="button" id="open-modal" data-target="#addr_Modal" style="position: relative;top:94px;">사용자 위치</button>
